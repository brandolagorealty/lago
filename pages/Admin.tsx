...
const Admin: React.FC = () => {
    ...
    const [activeTab, setActiveTab] = useState<'dashboard' | 'inventory' | 'tasks' | 'crm' | 'appraiser' | 'prospector' | 'farming' | 'team' | 'seguridad' | 'auditoria' | 'blog'>('dashboard');
    ...
    return (
        <div className="min-h-screen bg-[#EFEFEF] flex animate-in fade-in duration-500 overflow-x-hidden">
                    ...
                    {currentUserRole === 'superadmin' && (
                        <>
                            ...
                            <button
                                ...
                                className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl font-bold transition-all text-sm ${activeTab === 'blog' ? 'bg-[#1F5566] text-[#EFEFEF] shadow-lg shadow-[#1F5566]/20' : 'text-[#EFEFEF]/60 hover:bg-white/5 hover:text-[#EFEFEF]'}`}
                            >
                                ...
                                <span className="truncate">Blog Inmobiliario</span>
                            </button>
                            <button
            ...
            <div className="flex-1 md:ml-64 flex flex-col min-w-0 transition-all duration-300">
                ...
                {activeTab === 'blog' && currentUserRole === 'superadmin' && (
                    <BlogManagerTab onToast={setToast} />
                )}
