                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        <Link to="/" className="flex items-center">
                            <img src="/assets/logo2.png" alt="Lago Realty" className="h-32 w-auto" />
                        </Link>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-center group">
                                ...
                                <span className="text-slate-400 text-sm group-hover:text-white transition-colors">+58 (424) 692-6562</span>
                            </li>
                            <li className="flex items-center group">
                                <svg className="w-5 h-5 text-brand-green mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
